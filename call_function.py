...
schema_get_file_content = types.FunctionDeclaration(
    ...
    description="Reads the contents of a specific file, constrained to the working directory.",
    parameters=types.Schema(
        type=types.Type.OBJECT,
        properties={
...
schema_run_python_file = types.FunctionDeclaration(
    ...
    parameters=types.Schema(
        ...
        properties={
            ...
            "args": types.Schema(
                type=types.Type.STRING,
                description="Optional Arguments to pass to function"
            )
        },
    ),
)
...
schema_write_file_content = types.FunctionDeclaration(
    ...
    description="Write changes to the specified file, constrained to the working directory.",
    parameters=types.Schema(
        type=types.Type.OBJECT,
        properties={
            "file_path": types.Schema(
